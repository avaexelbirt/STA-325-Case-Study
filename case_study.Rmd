...
```
It looks like the square root transformation is the best because none of the original ST values are negative and thus they aren't negative after being square rooted, while the log transformation does make them negative. 
