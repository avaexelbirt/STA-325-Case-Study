...
This model before cross validation has an $R^2$ of 0.457 which is fairly close to the $R^2$ of the model above.

\*\* STOPPED HERE... add the rMSE for original model
