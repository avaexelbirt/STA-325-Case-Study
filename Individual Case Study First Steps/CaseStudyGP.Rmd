...
data <- cbind(data, central_moments)
...
Explore a log transformation of the mean – since some values are negative, I am going to add a constant to each of the values so that they are positive and then log-transform them
