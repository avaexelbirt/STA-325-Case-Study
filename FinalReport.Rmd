...
An ANOVA test revealed that Reynolds number has by far the largest effect (Sum of Squares = 431.68), followed by Stokes number, and then Froude number on explaining mean cluster volume. Twointeraction terms were statistically significant (p \< 0.05), with the Re:logistic_Fr interaction having the largest effect. The significant √St:logistic_Fr interaction interaction suggest that the effects of particle inertia (St) on mean cluster size depends primarily on gravitational conditions. 5-fold cross-validation yielded a RMSE only slightly higher than the training RMSE with a comparable $R^2$ value. This close agreement between training and validation performance indicates that the model generalizes well to unseen data and does not appear to overfit the data despite its polynomial and interaction terms.
